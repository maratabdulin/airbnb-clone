...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    "@app/core/numerals/common": [
      "<rootDir>/src/app/core/numerals/common/index.ts",
    ],
    "@app/core/numerals/shared": [
      "<rootDir>/src/app/core/numerals/shared/index.ts",
    ],
    "@app/core/numerals/utils": [
      "<rootDir>/src/app/core/numerals/utils/index.ts",
    ],
