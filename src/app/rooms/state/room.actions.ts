...
import { ChangedRoom, NewRoom, Room, RoomEntity } from "@app/rooms/common";
...
export const removeRoomSuccess = createAction(
  "[Room] Remove Room Success",
  payload<Entity>(),
);

export const removeRoomFailure = createAction(
  "[Room] Remove Room Failure",
  payload<Record<string, any> & Entity>(),
);

export const removeRooms = createAction(
  "[Room] Remove Rooms",
  payload<number[]>(),
);
...
export const removeRoomsSuccess = createAction(
  "[Room] Remove Rooms Success",
  payload<number[]>(),
);

export const removeRoomsFailure = createAction(
  "[Room] Remove Rooms Failure",
...
export const changeRoom = createAction(
  "[Room] Change Room",
  payload<ChangedRoom>(),
);
...
export const changeRoomSuccess = createAction(
  "[Room] Change Room Success",
  payload<ChangedRoom>(),
);

export const changeRoomFailure = createAction(
  "[Room] Change Room Failure",
  payload<Record<string, any>>(),
);
