...
export class BookingPortletComponentPo<T> extends PageObject<T> {
  get bookingPortletCarousel(): DebugElement | null {
    return (
      this.getByAutomationId(BookingPortletAutomation.BookingPortletCarousel) ??
      null
    );
  }
  ...
  get bookingPortletActionHref(): string | null {
    return (
      this.getByAutomationId(BookingPortletAutomation.BookingPortletAction)
  ...
  triggerBookingPortletSelected(): void {
