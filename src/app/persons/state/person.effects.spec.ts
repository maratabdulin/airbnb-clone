...
describe("PersonEffects", () => {
  ...
  describe("loadPersons$", () => {
    it("should return load perosn success", () => {
      const action = PersonActions.loadPersons();
      const completion = PersonActions.loadPersonsSuccess({
        payload: PERSONS_STUB,
      });
    ...
    it("should return load person failure", () => {
      const action = PersonActions.loadPersons();
      const completion = PersonActions.loadPersonsFailure({
