...
describe("CarouselComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    void TestBed.configureTestingModule({
      imports: [
        MockModule(CarouselDotsModule),
        MockModule(CarouselNavsModule),
        MockModule(CarouselSlideModule),
      ],
  ...
  it("should select slide after click on dot", () => {
    const selected = spyOn(
      pageObject.carousel?.componentInstance,
      "onSelected",
    );
    fixtureWrapper.detectChanges();
