...
export class GoogleMapComponentsPo extends PageObject<WrapperComponent> {
  ...
  get mapInfoWindowClosed(): any {
    return (
      this.getByAutomationId(GoogleMapAutomation.GoogleMap)?.componentInstance
        ?.mapInfoWindowClosed ?? null
    );
  }
